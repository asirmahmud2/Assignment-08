                ...
                <div className='relative hidden lg:flex items-center justify-center bg-[#1E1E1E] p-10 overflow-hidden'>
                    ...
                    <div className='relative z-10 text-center'>
                        ...
                        <p className='text-gray-300 leading-8 mt-6 max-w-md mx-auto'>
                            Create your account and explore premium
                            summer essentials crafted for luxury,
                    ...
                    <div className='w-full'>
                        ...
                        <div className='mt-10'>
                            ...
                            <p className='text-[#6B7280] mt-4 leading-7'>
                                Create your account and start your premium
                                summer shopping journey.
                            </p>
                        </div>
                        <form onSubmit={handleSubmit(handleRegister)} className='mt-10 space-y-6'
                        >
                            <div>
                        ...
                        <p className='text-center lg:text-left text-[#6B7280] mt-8'>
                            ...
                            <Link href={"/login"} className='text-[#FF7A00] font-bold ml-2 hover:underline'
                            >
                                Login </Link>
                        </p>
                    </div>
